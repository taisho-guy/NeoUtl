...
Item {
    ...
    readonly
    property int timelineLengthFrames: Math.max(100, sceneTotalFrames, maxClipEndFrame + tailPaddingFrames)
    ...
    Flickable {
        ...
        MouseArea {
            ...
            onReleased: (mouse) => {
                ...
                if (Workspace.currentTimeline) {
                    syncBoxSelectionPreview();                     Workspace.currentTimeline.finalizeSelectionPreview();
                }
                boxSelecting = false;
            }
        }
