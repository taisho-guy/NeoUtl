...
Item {
    ...
    readonly
    property bool committedSelected: ((Workspace.currentTimeline && Workspace.currentTimeline.selection) ? (Workspace.currentTimeline.selection.selectedClipIds.includes(modelData.id)) : false)
    ...
    readonly
    property bool forcedSelected: forceVisualSelection && forcedSelectedIds.includes(modelData.id)
    readonly property bool isSelected: previewSelected || (forceVisualSelection ? forcedSelected : committedSelected)
    readonly
    property bool isLayerLocked: getLayerLocked(modelData.layer)
    property int effectRevision: 0
    readonly
    property int controlLayerCount: {
    ...
    Rectangle {
        ...
        readonly
    property color _baseColor: _rawColor !== "" ? _rawColor : Qt.darker(palette.highlight, 1.6)
    ...
    property bool resizing: false
                ...
                onReleased: {
                    ...
                    if (Workspace.currentTimeline && clipDelegate.resizeDraftDuration > 0) {
                        ...
                        clipResized(modelData.id, deltaStart, deltaDuration, 0);                     }
