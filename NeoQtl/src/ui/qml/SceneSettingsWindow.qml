...
Common.AviQtlWindow {
    ...
    property bool isCreationMode: false
    property int targetSceneId: -1

        function openForCreate(defaultName) {
        isCreationMode = true;         targetSceneId = -1;         nameField.text = defaultName;
