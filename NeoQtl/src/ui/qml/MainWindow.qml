...
ApplicationWindow {
    ...
    Action {
        ...
        onTriggered: {
            if (Workspace.currentTimeline) {
                ...
                Workspace.currentTimeline.setLayerState(l, !isLocked, 0);             }
        }
    }
    ...
    Action {
        ...
        onTriggered: {
            if (Workspace.currentTimeline) {
                ...
                Workspace.currentTimeline.setLayerState(l, !isHidden, 1);             }
        }
    }
    ...
    Dialog {
        ...
        onAccepted: {
            ...
            pendingAction = null;             if (Workspace.currentTimeline) {
                if (Workspace.currentTimeline.currentProjectUrl === "") {
                    ...
                    sourceComponent: TabBar {
                        ...
                        Repeater {
                            ...
                            TabButton {
                                ...
                                readonly
    property color _displayBgColor: checked ? palette.highlight : palette.window
